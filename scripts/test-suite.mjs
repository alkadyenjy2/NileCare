...
const [d,o,p,w,m,ci,s,n,sp,sql]=await Promise.all([
 ...
 file("supabase/002_production_hardening.sql"),file("nilecare-landing/lib/neon.ts"),file("nilecare-landing/lib/supabase.ts"),file("supabase/001_nilecare_core.sql")
]);
const checks=[
...
const values=[d,d,d,d,o,o,p,p,w,w,m,m,s,s,s,s,ci,ci,ci,ci,p,w,n,sp,sql];
